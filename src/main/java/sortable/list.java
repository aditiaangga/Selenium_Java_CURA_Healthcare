...
public class list {
    ...
    public void list() {
        ...
        WebElement six = driver.findElement(By.xpath("//div[@id='demo-tabpane-list']//div[text()='Six']"));

        System.out.println(one.getText()+ " to "+six.getText());
        act.dragAndDrop(one, six).perform();

        WebElement three = driver.findElement(By.xpath("//div[@id='demo-tabpane-list']//div[text()='Three']"));
        WebElement five = driver.findElement(By.xpath("//div[@id='demo-tabpane-list']//div[text()='Five']"));

        System.out.println(five.getText()+ " to "+three.getText());
        act.dragAndDrop(five, three).perform();

        WebElement two = driver.findElement(By.xpath("//div[@id='demo-tabpane-list']//div[text()='Two']"));
